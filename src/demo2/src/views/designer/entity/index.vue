<template>
  <div class="app-container">
    <section class="entityapp">
      ...
      <!-- main section -->
      <section v-show="entity.properties.length" class="main">
        <ul class="property-list">
          <disabled-property :property="entity.id" />
          <draggable v-model="entity.properties" :options="{group:'properties'}" @start="drag=true" @end="drag=false">
            <property
              v-for="(property, name) in entity.properties"
              :key="name"
              :property="property"
      ...
      <!-- footer -->
      <footer v-show="entity.properties.length" class="footer">
        Ready
      </footer>
    </section>
  </div>

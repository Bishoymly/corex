...
namespace CoreX.Emit.Swagger
{
    ...
    public class Paths
    {
        ...
        public ProductFindbystatus productfindByStatus { get; set; }
        public ProductFindbytags productfindByTags { get; set; }
        public ProductPetid productpetId { get; set; }
    ...
    public class ProductFindbystatus
    {
    ...
    public class ProductFindbytags
    {
